...
fun main(args: Array<String>) {
    ...
    driver(dsl = {
        startNode("Controller", setOf(ServiceInfo(ValidatingNotaryService.type), ServiceInfo(AGBOracleService.type)))
        startNode("Amphia", rpcUsers = listOf(user))
        startNode("CZ", rpcUsers = listOf(user))
