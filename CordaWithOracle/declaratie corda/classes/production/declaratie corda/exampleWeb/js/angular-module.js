...
app.controller('DemoAppController', function($http, $location, $uibModal) {
    ...
    const apiBaseURL = "http://localhost:" + nodePort + "/api/declaratie/";
    let peers = [];
    ...
    demoApp.getPOs = () => $http.get(apiBaseURL + "declaraties")
...
app.controller('ModalInstanceCtrl', function ($http, $location, $uibModalInstance, $uibModal, apiBaseURL, peers) {
    ...
    modalInstance.create = () => {
        if (invalidFormInput()) {
            ...
            const po = {
                declaratieNummer: modalInstance.form.declaratieNummer,
                agbCode: modalInstance.form.agbCode,
                uzoviCode: modalInstance.form.uzoviCode
            };
    ...
    function invalidFormInput() {
        const invalidNonItemFields = !modalInstance.form.declaratieNummer
            || isNaN(modalInstance.form.declaratieNummer)
            || !modalInstance.form.uzoviCode
            || !modalInstance.form.agbCode;
