...
object DeclaratieFlow {
    class Initiator(val po: DealState,
                    ...
                    override val progressTracker: ProgressTracker = Initiator.tracker()): FlowLogic<DeclaratieFlowResult>() {
        /**
    ...
    class Acceptor(val otherParty: Party,
                   override val progressTracker: ProgressTracker = Acceptor.tracker()): FlowLogic<DeclaratieFlowResult>() {
        companion object {
