 ...
 */
data class DeclaratieState(val po: Declaratie,
                              val buyer: Party,
                              val seller: Party,
                              override val contract: DeclaratieContract,
                              override val linearId: UniqueIdentifier = UniqueIdentifier(po.declaratieNummer.toString())):
        DealState {
    ...
    override fun generateAgreement(notary: Party): TransactionBuilder {
        return TransactionType.General.Builder(notary)
                .withItems(this, Command(DeclaratieContract.Commands.Indienen(), parties.map { it.owningKey }))
    }
