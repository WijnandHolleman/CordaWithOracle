...
import com.example.service.AgbRegisterOracleService
...
class ExamplePlugin : CordaPluginRegistry() {
     ...
     *
     *      "ExampleFlow.Zorgaanbieder" -> Set(PurchaseOrderState, Party)
     *
    ...
    override val requiredFlows: Map<String, Set<String>> = mapOf(
            DeclaratieFlow.Zorgaanbieder::class.java.name to setOf(DeclaratieState::class.java.name, Party::class.java.name)
    )
    /**
...
//            AgbRegisterOracleService.Service::class.java)
