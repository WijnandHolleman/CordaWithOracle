...
//            }
        ...
        fun signWiretransaction(wtx: WireTransaction, merkleRoot: SecureHash): DigitalSignature.LegallyIdentifiable
        {
            //TODO: Niet alles signen!
            return signingKey.signWithECDSA(merkleRoot.bytes, identity)
        }
...
//        override val requiredFlows = mapOf(Pair(DeclaratieFlow.FixingRoleDecider::class.java.name, setOf(Duration::class.java.name, StateRef::class.java.name)))
...
//        }
//
//        private class FixQueryHandler(val zorgverzekeraarParty: Party, val service: Service) : FlowLogic<Unit>() {
//            companion object {
